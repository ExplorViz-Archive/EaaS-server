 ...
 * <p>
 * The standard implementation for this is {@link DockerJavaImplementation} which uses the <b>docker-java</b> library.
 * This library isn't maintained very well and at some point we might want to consider switching to the
...
public interface DockerAdapter {
     ...
     *
     * @param input Stream to read the image from. The adapter will not close the stream
     */
